...
SELECT
    ...
    MAX(cp.active_zones_population / cp.total_population) AS active_zones_population_share,
    MAX(i.internet_access_perc) AS internet_access_perc,
    MAX(a.population_ages_15_64_perc) AS population_ages_15_64_perc,
...
,kpi AS (
  SELECT
    ...
    LEFT JOIN population p on o.country_code = lower(p.country_code) and date_trunc(created_date_local, month) = p.month
