...
# Global inputs
base_url = "https://gadm.org/download_country.html" # GADM website where we will download the shape files
downloads_dir = f"C:/Users/{os.getenv('USERNAME')}/Downloads" # Default downloads directory on Windows. You might need to change this if you are using a Mac or Linux
final_downloads_dst = f"{os.getcwd()}/shape_files" # The final destination of the downloaded shape files
