move join countries to the end
check if we can use fct_ops instead of logistics schemas
use distkey to make the code faster
read about diststyle all

reach out to Kevin viraud about training

add the ddl in the beginning
and transform the last one into insert like tableau_monthly_report_city
