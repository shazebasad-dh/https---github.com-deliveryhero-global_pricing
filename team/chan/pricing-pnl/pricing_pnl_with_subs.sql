...
SET from_date_filter = "2023-01-31";
SET to_date_filter = "2023-06-01";


CREATE OR REPLACE TABLE `dh-logistics-product-ops.pricing._pricing_data_with_subs`
...
SELECT
  ...
  , exchange_rate
  , CASE 
      WHEN has_subscription_and_free_delivery then TRUE
      WHEN has_subscription_partial_discount then TRUE 
    ELSE FALSE
